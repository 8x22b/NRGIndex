  ...
  drinks: [
    ...
    },
    {
      ...
      ratings: {
        ...
        roma: {
          tier: "S",
          review: "Самый охуенный энергос: очень вкусный, яркий и идеально узнаваемый оригинальный Adrenaline Rush. Никаких сомнительных экспериментов — просто эталонная банка, к которой хочется возвращаться."
        }
      }
    },
    {
